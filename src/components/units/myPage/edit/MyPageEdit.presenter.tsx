...
export default function MyPageEditUI(props) {
  ...
  return (
    <>
      <My.Container>
        {props.isOpen && (
          <My.Modal onClick={props.onClickOutSide}>
            <div className="modal-section" ref={props.modalRef}>
              <div className="modal-content">
                <DaumPostcode onComplete={props.onClickAddressComplete} />
              </div>
            </div>
          </My.Modal>
        )}
          ...
          <My.EditWrapper>
            ...
            <My.ProfileWrapper>
              ...
              <My.InputWrapper>
                ...
                <NormalButton title={"찾기"} onClick={props.onClickAddress} />
              </My.InputWrapper>
              <My.InputWrapper>
                <My.Label />
